...
export function Footer() {
  return (
    <footer className="bg-primary/5 text-primary-foreground">
      <div className="container mx-auto px-4 py-12 lg:py-16">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-4">
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              {socialLinks.map((social) => (
                <a key={social.label} href={social.href} className="text-foreground/60 hover:text-foreground">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-foreground/80">Recibe las últimas noticias y ofertas especiales directamente en tu bandeja de entrada.</p>
