                    ...
                    <Card key={index} className="overflow-hidden">
                      <CardHeader>
                        ...
                        <CardTitle className="text-xl">
                          <Link href={release.link} className="hover:text-primary transition-colors">
                            {release.title}
                          </Link>
                        </CardTitle>
                      </CardHeader>
                      <CardContent>
                        ...
                        <Link href={release.link} className="text-sm font-semibold text-primary hover:underline flex items-center gap-1 mt-4">
